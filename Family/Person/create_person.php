...
<div class="form-group">
    ...
    <select name="family_id" required>
        ...
        $select_family = "SELECT * FROM family_members";
        $garndfather = $conn->query($select_family);
        while($family=mysqli_fetch_array($garndfather)){
            $family_id         = $family['id'];
            $family_name       = $family['grandfather'];
            echo "<option value = '" .$family_id. "'>" .$family_name. "</option>";
        }                     
		?>
	</select> 
</div>
